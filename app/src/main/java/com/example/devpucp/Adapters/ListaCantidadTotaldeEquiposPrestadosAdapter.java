...
public class ListaCantidadTotaldeEquiposPrestadosAdapter extends RecyclerView.Adapter<ListaCantidadTotaldeEquiposPrestadosAdapter.ViewHolder>{
    ...
    public ListaCantidadTotaldeEquiposPrestadosAdapter(Context contexto, ArrayList<Dispositivo> dataSet){
        context = contexto;
    ...
    @NonNull
    @Override
    public ListaCantidadTotaldeEquiposPrestadosAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.rv_admin_dispositivos_prestados_, parent,false);
        return new ListaCantidadTotaldeEquiposPrestadosAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull ListaCantidadTotaldeEquiposPrestadosAdapter.ViewHolder holder, int position) {
