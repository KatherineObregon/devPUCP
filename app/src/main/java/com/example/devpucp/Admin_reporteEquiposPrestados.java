...
public class Admin_reporteEquiposPrestados extends AppCompatActivity {
    ...
    ListaCantidadTotaldeEquiposPrestadosAdapter ListaCantidadTotaldeEquiposPrestadosAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_reporte_equipos_prestados);

        textViewTotalPrestados = findViewById(R.id.textView_Admin_TotalPrestados);
...
//        });
        ...
        RecyclerView recyclerView = findViewById(R.id.RecyclerViewDispositivosPrestadosAdmin);
        Log.d("msg", "despues de cargar y filtra vuelve a on creatr eventos");
        ListaCantidadTotaldeEquiposPrestadosAdapter = new ListaCantidadTotaldeEquiposPrestadosAdapter(Admin_reporteEquiposPrestados.this,firebaseDispositivosFiltrado);
        recyclerView.setAdapter(ListaCantidadTotaldeEquiposPrestadosAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Admin_reporteEquiposPrestados.this));
    ...
    public void filtrarDispositivos(){
        ...
        ListaCantidadTotaldeEquiposPrestadosAdapter.notifyDataSetChanged();
